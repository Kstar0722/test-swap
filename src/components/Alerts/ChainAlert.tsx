...
export const ChainAlert = () => {
  ...
  const { sourceChainToken, destinationChainToken } = useChainTokenSelectionStore();
  ...
  const { isSuccess: isWalletCheckSuccess, isWalletLinked } = useCheckWalletLinking({
    userAddress: account?.address,
    checkWalletLinking:
      sourceChainToken?.chainId === ChainId.SEI || destinationChainToken?.chainId === ChainId.SEI,
  });
