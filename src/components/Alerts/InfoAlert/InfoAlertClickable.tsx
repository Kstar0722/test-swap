...
import { InfoMessageCardClickable, InfoMessageCardTitle } from '@/components/MessageCard';

import { ButtonInfoAlertClickable, InfoAlertButton, InfoAlertContainer } from '.';
...
export const InfoAlertClickable = ({ title, subtitle, active, buttonText }: InfoAlertProps) => {
      ...
      <InfoAlertContainer>
        ...
        >
          <InfoMessageCardClickable>
            ...
            <Typography variant={'body1'} pt={theme.spacing(1.5)} color={'#000'}>
              {subtitle}
            </Typography>
