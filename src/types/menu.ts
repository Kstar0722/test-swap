...
export interface MenuState extends MenuProps {
  ...
  setEcosystemSelectMenuState: (open: boolean, combinedWallet?: CombinedWallet) => void;

  // Toggle Sub Menu
  setSubMenuState: (subMenu: keyof typeof MenuKeys) => void;

  // Open Snackbar and set label
  setSnackbarState: (open: boolean, label?: string, severity?: SnackbarSeverityType) => void;
