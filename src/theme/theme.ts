...
const themeCustomized = createTheme({
  ...
  components: {
    ...
    MuiScopedCssBaseline: {
      styleOverrides: {
        root: {
          fontFamily: `Arial, Noto Sans, BlinkMacSystemFont, Segoe UI, Helvetica Neue, sans-serif`,
        },
      },
    },
    MuiSnackbar: {
...
export const lightTheme = createTheme(
  deepmerge(themePreset, {
    palette: {
      mode: 'light',
      background: {
        default: 'linear-gradient(180deg, #F9F5FF 0%, #F3EBFF 49.48%, #F9F5FF 99.48%)',
      },
      text: {
        primary: '#000',
        secondary: alpha('black', 0.75),
      },
      grey: {
        300: '#E5E1EB',
      },
...
export const darkTheme = createTheme(
  deepmerge(themePreset, {
    ...
    palette: {
      mode: 'dark',
      background: {
        default: 'linear-gradient(180deg, #000000 0%, #0C001F 49.48%, #000000 99.48%)', //'#241D52',
      },
      text: {
        primary: '#fff',
        secondary: alpha('white', 0.75),
      },
      grey: {
        800: '#302B52',
      },
