...
import { defaultSettings } from '@/configs/config';
import type { PartnerThemeConfig } from '@/types/PartnerThemeConfig';
import type { SettingsProps, SettingsState, ThemeModesSupported } from '@/types/settings';
...
export const useSettingsStore = createWithEqualityFn(
  persist(
    (set, get) => ({
      ...
      setDefaultSettings: () => {
        set({
          themeMode: defaultSettings.themeMode || ('system' as ThemeModesSupported),
