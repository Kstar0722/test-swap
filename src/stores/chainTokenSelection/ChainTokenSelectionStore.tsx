...
const queryParameters =
  typeof window !== 'undefined' && window?.location && new URLSearchParams(window.location.search);
...
export const useChainTokenSelectionStore = createWithEqualityFn<ChainTokenSelectionState>(
  (set) => ({
    sourceChainToken: {
